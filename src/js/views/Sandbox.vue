<template>
    <div class="mx-2 md:mx-8 mt-20 pt-1 pb-4 font-light">
      ...
      <div v-if="this.$parent.wikidata_sandbox != 0">
        <a class="inline-flex items-center uppercase mt-4 py-2 pl-3 pr-4 rounded hover:bg-gray-200 hover:text-blue-wiki-hover transition-03" href="#" v-if="this.$parent.wikidata_sandbox != 0" v-on:click="download($event)">
          <i class="fill-current flex-initial mr-3 w-6 h-6 ">
        ...
        <a class="inline-flex items-center uppercase mt-2 py-2 pl-3 pr-4 rounded hover:bg-gray-200 hover:text-blue-wiki-hover transition-03" href="#" v-if="this.$parent.wikidata_sandbox != 0" v-on:click="download($event)">
          <i class="fill-current flex-initial mr-3 w-6 h-6 ">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path class="heroicon-ui" d="M11 14.59V3a1 1 0 0 1 2 0v11.59l3.3-3.3a1 1 0 0 1 1.4 1.42l-5 5a1 1 0 0 1-1.4 0l-5-5a1 1 0 0 1 1.4-1.42l3.3 3.3zM3 17a1 1 0 0 1 2 0v3h14v-3a1 1 0 0 1 2 0v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3z"/>
            </svg>
