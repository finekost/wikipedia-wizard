var stripKeys = function(table, remove) {
...
var patchKeys = function(rows, keysToPatch) {
...
var stripRowsWhereKeyHasValue = function(rows, key, remove) {
...
export {stripKeys, patchKeys, stripRowsWhereKeyHasValue}